...
import 'package:behn_meyer_flutter/dio/api/home/crop_programme_crop_type_api.dart';
...
class CropProgrammeCropTypeList extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _CropProgrammeCropTypeList();
  }
}

class _CropProgrammeCropTypeList extends State<CropProgrammeCropTypeList> {
  final scrollController = ScrollController();
  double scrollMark;
  bool isReversing = false;
  bool isScroll = false;

  Future<List<dynamic>> fetchCropProgrammeCropTypeList(BuildContext ctx) {
    CropProgrammeCropTypeApi cropTypeApi = CropProgrammeCropTypeApi(ctx);
    return cropTypeApi.call(true);
  }
  ...
  void initState() {
    ...
    FirebaseAnalytics().setCurrentScreen(
        screenName: Constants.analytics_crop_programme_crop_type_list);
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: FutureBuilder(
          future: !isScroll ? fetchCropProgrammeCropTypeList(context) : null,
          builder:
                  ...
                  child: RefreshIndicator(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        labelText(
                          Util.getTranslated(
                              context, "crop_programme_choose_crop_type_text"),
                          AppFont.regular(
                            14,
  ...
  Widget cropCategoryItem(BuildContext context, CropCategoryDTO categoryDTO) {
    return GestureDetector(
      onTap: () {
        Navigator.pushNamed(context, MyRoute.cropProgrammeWebBrowserRoute,
